...
dataPessoas = [
    { id: 'Deus', nome: 'Deus', regexp: new Expressao(/Deus/g)},
    { id: 'adao', nome: 'Adão', regexp: new Expressao(/Adão/g)},
    { id: 'abel', nome: 'Abel', regexp: new Expressao(/Abel/g)},
    { id: 'caim', nome: 'Caim', regexp: new Expressao(/Caim/g)},
    { id: 'jaco', nome: 'Jacó', regexp: new Expressao(/Jacó|Israel/g)},
    { id: 'jose', nome: 'José', regexp: new Expressao(/José/g)},
    { id: 'ruben', nome: 'Rúben', regexp: new Expressao(/Rúben/g)},
    { id: 'enoque', nome: 'Enoque', regexp: new Expressao(/Enoque/g)},
    { id: 'palu', nome: 'Palu', regexp: new Expressao(/Palu/g)},
    { id: 'hezromBenRuben', nome: 'Hezrom', regexp: new Expressao(/Hezrom/g)},
    { id: 'carmi', nome: 'Carmi', regexp: new Expressao(/Carmi/g)},
    { id: 'simeao', nome: 'Simeão', regexp: new Expressao(/Simeão/g)},
    { id: 'jemuel', nome: 'Jemuel', regexp: new Expressao(/Jemuel/g)},
    { id: 'jamim', nome: 'Jamim', regexp: new Expressao(/Jamim/g)},
    { id: 'oade', nome: 'Oade', regexp: new Expressao(/Oade/g)},
    { id: 'jaquim', nome: 'Jaquim', regexp: new Expressao(/Jaquim/g)},
    { id: 'zoar', nome: 'Zoar', regexp: new Expressao(/Zoar/g)},
    { id: 'saul', nome: 'Saul', regexp: new Expressao(/Saul/g)},
    { id: 'mulherSimeao', nome: 'cananeia(?)', regexp: new Expressao(/uma mulher cananeia/g)},
    { id: 'lia', nome: 'Lia', regexp: new Expressao(/Lia/g)},
    { id: 'levi', nome: 'Levi', regexp: new Expressao(/Levi/g)},
    { id: 'juda', nome: 'Judá', regexp: new Expressao(/Judá/g)},
    { id: 'issacar', nome: 'Issacar', regexp: new Expressao(/Issacar/g)},
    { id: 'zebulom', nome: 'Zebulom', regexp: new Expressao(/Zebulom/g)},
    { id: 'perez', nome: 'Perez', regexp: new Expressao(/Perez/g)},
    { id: 'gerson', nome: 'Gérson', regexp: new Expressao(/Gérson/g)},
    { id: 'coate', nome: 'Coate', regexp: new Expressao(/Coate/g)},
    { id: 'merari', nome: 'Merari', regexp: new Expressao(/Merari/g)},
    { id: 'er', nome: 'Er', regexp: new Expressao(/Er/g)},
    { id: 'ona', nome: 'Onã', regexp: new Expressao(/Onã/g)},
    { id: 'sela', nome: 'Selá', regexp: new Expressao(/Selá/g)},
    { id: 'zera', nome: 'Zerá', regexp: new Expressao(/Zerá/g)},
    { id: 'tola', nome: 'Tola', regexp: new Expressao(/Tola/g)},
    { id: 'puva', nome: 'Puva', regexp: new Expressao(/Puva/g)},
    { id: 'jo', nome: 'Jó', regexp: new Expressao(/Jó/g)},
    { id: 'sinrom', nome: 'Sinrom', regexp: new Expressao(/Sinrom/g)},
    { id: 'serede', nome: 'Serede', regexp: new Expressao(/Serede/g)},
    { id: 'elom', nome: 'Elom', regexp: new Expressao(/Elom/g)},
    { id: 'jaleel', nome: 'Jaleel', regexp: new Expressao(/Jaleel/g)},
    { id: 'hezrom', nome: 'Hezrom', regexp: new Expressao(/Hezrom/g)},
    { id: 'hamul', nome: 'Hamul', regexp: new Expressao(/Hamul/g)},
    { id: 'dina', nome: 'Diná', regexp: new Expressao(/Diná/g)},
    { id: 'gade', nome: 'Gade', regexp: new Expressao(/Gade/g)},
    { id: 'aser', nome: 'Aser', regexp: new Expressao(/Aser/g)},
    { id: 'zilpa', nome: 'Zilpa', regexp: new Expressao(/Zilpa/g)},
    { id: 'zifiom', nome: 'Zifiom', regexp: new Expressao(/Zifiom/g)},
    { id: 'hagi', nome: 'Hagi', regexp: new Expressao(/Hagi/g)},
    { id: 'suni', nome: 'Suni', regexp: new Expressao(/Suni/g)},
    { id: 'esbom', nome: 'Esbom', regexp: new Expressao(/Esbom/g)},
    { id: 'eri', nome: 'Eri', regexp: new Expressao(/Eri/g)},
    { id: 'arodi', nome: 'Arodi', regexp: new Expressao(/Arodi/g)},
    { id: 'areli', nome: 'Areli', regexp: new Expressao(/Areli/g)},
    { id: 'imna', nome: 'Imna', regexp: new Expressao(/Imna/g)},
    { id: 'isva', nome: 'Isvá', regexp: new Expressao(/Isvá/g)},
    { id: 'isvi', nome: 'Isvi', regexp: new Expressao(/Isvi/g)},
    { id: 'berias', nome: 'Berias', regexp: new Expressao(/Berias/g)},
    { id: 'sera', nome: 'Sera', regexp: new Expressao(/Sera/g)},
    { id: 'heber', nome: 'Héber', regexp: new Expressao(/Héber/g)},
    { id: 'malquiel', nome: 'Malquiel', regexp: new Expressao(/Malquiel/g)},
    { id: 'labao', nome: 'Labão ', regexp: new Expressao(/Labão/g)},
    { id: 'raquel', nome: 'Raquel', regexp: new Expressao(/Raquel/g)},
    { id: 'benjamim', nome: 'Benjamim', regexp: new Expressao(/Benjamim/g)},
    { id: 'azenate', nome: 'Azenate', regexp: new Expressao(/Azenate/g)},
    { id: 'potifera', nome: 'Potífera', regexp: new Expressao(/Potífera/g)},
    { id: 'manasses', nome: 'Manassés', regexp: new Expressao(/Manassés/g)},
    { id: 'efraim', nome: 'Efraim', regexp: new Expressao(/Efraim/g)},
    { id: 'farao', nome: 'Faraó ', regexp: new Expressao(/Faraó/g)},
    { id: 'da', nome: 'Dã', regexp: new Expressao(/Dã/g)},
    { id: 'naftali', nome: 'Naftali', regexp: new Expressao(/Naftali/g)},
    { id: 'bela', nome: 'Belá', regexp: new Expressao(/Belá/g)},
    { id: 'bequer', nome: 'Béquer', regexp: new Expressao(/Béquer/g)},
    { id: 'asbel', nome: 'Asbel', regexp: new Expressao(/Asbel/g)},
    { id: 'gera', nome: 'Gera', regexp: new Expressao(/Gera/g)},
    { id: 'naama', nome: 'Naamã', regexp: new Expressao(/Naamã/g)},
    { id: 'ei', nome: 'Eí', regexp: new Expressao(/Eí/g)},
    { id: 'ros', nome: 'Rôs', regexp: new Expressao(/Rôs/g)},
    { id: 'mupim', nome: 'Mupim', regexp: new Expressao(/Mupim/g)},
    { id: 'hupim', nome: 'Hupim', regexp: new Expressao(/Hupim/g)},
    { id: 'arde', nome: 'Arde', regexp: new Expressao(/Arde/g)},
    { id: 'husim', nome: 'Husim', regexp: new Expressao(/Husim/g)},
    { id: 'jazeel', nome: 'Jazeel', regexp: new Expressao(/Jazeel/g)},
    { id: 'guni', nome: 'Guni', regexp: new Expressao(/Guni/g)},
    { id: 'jezer', nome: 'Jezer', regexp: new Expressao(/Jezer/g)},
    { id: 'silem', nome: 'Silém', regexp: new Expressao(/Silém/g)},
    { id: 'bila', nome: 'Bila', regexp: new Expressao(/Bila/g)},
    //{ id: '', nome: '', regexp: new Expressao(/()/g)},
];
dataCasais = [
    { homem: 'simeao', mulher: 'mulherSimeao' },
    { homem: 'jaco', mulher: 'lia'},
    { homem: 'jaco', mulher: 'zilpa'},
    { homem: 'jaco', mulher: 'raquel'},
    { homem: 'jaco', mulher: 'bila'},
    { homem: 'jose', mulher: 'azenate'},
];
dataPaisFilhos = [
    { pai_mae: 'jaco', filhos: ['ruben', 'simeao', 'levi', 'juda', 'issacar', 'zebulom', 'dina', 
                            'gade', 'aser', 
                            'jose', 'benjamim',
                            'da', 'naftali'] },
    { pai_mae: 'adao', filhos: ['caim', 'abel']},
    { pai_mae: 'ruben', filhos: ['enoque', 'palu', 'hezromBenRuben', 'carmi']},
    { pai_mae: 'simeao', filhos: ['jemuel', 'jamim', 'oade', 'jaquim', 'zoar', 'saul']},
    { pai_mae: 'levi', filhos: ['gerson', 'coate', 'merari']},
    { pai_mae: 'juda', filhos: ['er', 'ona', 'sela', 'perez', 'zera']},
    { pai_mae: 'issacar', filhos: ['tola', 'puva', 'jo', 'sinrom']},
    { pai_mae: 'zebulom', filhos: ['serede', 'elom', 'jaleel']},
    { pai_mae: 'perez', filhos: ['hezrom', 'hamul']},
    { pai_mae: 'gade', filhos: ['zifiom', 'hagi', 'suni', 'esbom', 'eri', 'arodi', 'areli']},
    { pai_mae: 'aser', filhos: ['imna', 'isva', 'isvi', 'berias', 'sera']},
    { pai_mae: 'berias', filhos: ['heber', 'malquiel']},
    { pai_mae: 'labao', filhos: ['lia', 'raquel']},
    { pai_mae: 'potifera', filhos: ['azenate']},
    { pai_mae: 'jose', filhos: ['manasses', 'efraim']},
    { pai_mae: 'benjamim', filhos: ['bela', 'bequer', 'asbel', 'gera', 'naama', 'ei', 'ros', 'mupim', 'hupim', 'arde']},
    { pai_mae: 'da', filhos: ['husim']},
    { pai_mae: 'naftali', filhos: ['jazeel', 'guni', 'jezer', 'silem']},
    { pai_mae: 'mulherSimeao', filhos: ['jemuel', 'jamim', 'oade', 'jaquim', 'zoar', 'saul']},
    { pai_mae: 'lia', filhos: ['ruben', 'simeao', 'levi', 'juda', 'issacar', 'zebulom', 'dina']},
    { pai_mae: 'zilpa', filhos: ['gade', 'aser']},
    { pai_mae: 'raquel', filhos: ['jose', 'benjamim']},
    { pai_mae: 'azenate', filhos: ['manasses', 'efraim']},
    { pai_mae: 'bila', filhos: ['da', 'naftali']},
];

dataRelacionamentos = [];
dataCasais.forEach(function(d) {
    dataRelacionamentos.push({ source: d.homem, target: d.mulher, type: 'casal' });
});
dataPaisFilhos.reduce(function(array, data) {
    data.filhos.forEach(function(filho) {
        array.push({ source: data.pai_mae, target: filho , type: 'pai_mae_filho'});
    });
